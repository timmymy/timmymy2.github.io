...
/**
 * Servlet implementation class ToSelectCourseServlet
 */
@WebServlet("/manager/toSelectCourse")
public class ToSelectCourseServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/jsp/manager/selectCourse.jsp").forward(request, response);
	}
